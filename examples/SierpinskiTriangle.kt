...
fun sierpinskiTriangle() : ArrayList<TurtleCommand>
{
    ...
    */
    meanings.add(Meaning('A', TurtleCommand(0.0, true)))
    meanings.add(Meaning('B', TurtleCommand(0.0, true)))
    meanings.add(Meaning('-', TurtleCommand(60.0, false)))
    meanings.add(Meaning('+', TurtleCommand(-60.0, false)))
    parser.generate(8, rules)
